  ...
  <section class="py-10">
    <div class="container">
      ...
      <div class="flex items-center">
        <div
          class="w-1/2 bg-gray-300 mr-5 rounded-3xl flex justify-center itemscenter p-5 h-[500px]"
        >
          <img
        ...
        <div class="w-1/2 pl-5">
          ...
          <div class="flex flex-col gap-4">
            <div
              class="w-full flex items-center gap-2 bg-blue-600 text-white py3 justify-center rounded-lg cursor-pointer hover:bg-blue-600/80 transition duration-300 relative"
            >
