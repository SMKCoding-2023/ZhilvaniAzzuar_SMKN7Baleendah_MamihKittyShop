...
<template>
  <div class="w-full max-w-sm p-4 bg-white rounded-lg shadow-[0_30px_60px_rgba(0,0,0,0.15)] sm:p-6 md:p-8">
    <form class="" @submit.prevent="submitLogin">
      <div class="mb-6">
        <h5 class="text-2xl font-medium text-gray-900 mb-2 justify-center flex">Login</h5>
        <span class="text-sm font-normal text-gray-500">You must login</span>
      </div>
      ...
      <div class="text-sm font-medium text-gray-500">
          Don't have an Account ? <NuxtLink to="/register" class="text-red-700 hover:underline">Sign up</NuxtLink>
      </div>
    </form>
  </div>
</template>